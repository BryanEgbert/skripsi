...
func RegisterUserRoute(r *gin.Engine, userController *controller.UserController) *gin.Engine {
	...
	userRoutes.GET("/:id/saved-address", middleware.JWTAuth(), userController.GetSavedAddress)

	userRoutes.POST("/:id/saved-address", middleware.JWTAuth(), userController.AddSavedAddress)
