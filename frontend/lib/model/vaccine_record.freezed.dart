...
mixin _$VaccineRecord {
  ...
  String get dateAdministered => throw _privateConstructorUsedError;
...
abstract class $VaccineRecordCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {int id, String dateAdministered, String nextDueDate, String imageUrl});
}
...
class _$VaccineRecordImpl implements _VaccineRecord {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, dateAdministered, nextDueDate, imageUrl);
...
abstract class _VaccineRecord implements VaccineRecord {
  const factory _VaccineRecord(
      ...
      required final String dateAdministered,
      required final String nextDueDate,
      required final String imageUrl}) = _$VaccineRecordImpl;
