...
abstract class $TokenResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String accessToken, String refreshToken, int expiryDate});
}
...
class _$TokenResponseImpl implements _TokenResponse {
  ...
  @override
  String toString() {
    return 'TokenResponse(accessToken: $accessToken, refreshToken: $refreshToken, expiryDate: $expiryDate)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, accessToken, refreshToken, expiryDate);
...
abstract class _TokenResponse implements TokenResponse {
  const factory _TokenResponse(
      ...
      required final int expiryDate}) = _$TokenResponseImpl;
