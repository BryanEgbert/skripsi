...
class EditReviewModal extends ConsumerStatefulWidget {
  final PetDaycareDetails petDaycare;
  const EditReviewModal(this.petDaycare, {super.key});

  @override
  ConsumerState<EditReviewModal> createState() => _EditReviewModalState();
}

class _EditReviewModalState extends ConsumerState<EditReviewModal> {
