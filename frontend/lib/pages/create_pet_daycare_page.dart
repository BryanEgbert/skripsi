                ...
                Form(
                  child: Column(
                    ...
                    children: [
                      ...
                      Autocomplete<SuggestionDetailsResponse>(
                        ...
                        onSelected: (option) async {
                          ...
                          final res =
                              await _locationService.retrieveSuggestedLocation(
                                  _sessionId, option.mapboxId);

                          switch (res) {
                            case Ok<RetrieveResponse>():
                              _locality = res.value!.features[0].properties
                                  .context.locality!.name;
                              _latitude = res.value!.features[0].properties
                                  .coordinates.latitude;
                              _longitude = res.value!.features[0].properties
